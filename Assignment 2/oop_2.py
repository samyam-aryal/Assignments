...
class Customer:
    """
    Represents a customer with name, age, and address details.
    """
...
class BankAccount(Customer):
    ...
    def get_details(self):
        ...
        """
        print("\nBank details are:", self.name, self.age, 
        self.address, self.account_number, self.balance, self.account_type)
